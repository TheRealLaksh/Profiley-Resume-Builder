  ...
  education: [
    {
      ...
      details:
        "Pursuing rigorous coursework in Physics, Chemistry, Math, and CS."
    },
    {
      id: 2,
  ...
  experience: [
    {
      ...
      year: "8 Weeks",
      details:
        "Completed intensive program focused on Data Science, Data Engineering, and supervised/unsupervised learning models (KNN, K-Means)."
    },
    {
      id: 2,
      ...
      year: "Remote",
      details:
        "Developed user-centric applications including Helios (music player), Calibridge (calendar exporter), and CogniSync."
    },
    {
      id: 3,
